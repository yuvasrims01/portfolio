...
null===(t=this.onSelect)||void 0===t||t.call(this,e)},onKeyDown(e){if((0,n.isPresent)((0,i.get)(this,"groupUniqueId"))){const t=(0,i.get)(this,"groupUniqueId"),l=Array.from(document.querySelector(`#${t}`).querySelectorAll("button"))
let n=l.findIndex((e=>e===document.activeElement)),o=!1
if("ArrowDown"===e.key||"ArrowRight"===e.key){o=!0
n++
for(;n<l.length&&l[n].disabled;)n++}else if("ArrowLeft"===e.key||"ArrowUp"===e.key){o=!0
n--
for(;n>0&&l[n].disabled;)n--}o&&l[n]&&!l[n].disabled&&l[n].focus()}}}})}))
